...
export default function TechCard() {
  return (
    <Card>
      <div className="grid place-content-center space-y-20">
        <ContactForm />
        <p className="text-center">contact@xtcdev.com</p>
        <p className="text-center">(463) 239 8161</p>
      </div>
      <CardSkeletonContainer>
        <Skeleton />
      </CardSkeletonContainer>
      <CardTitle>Only the best technologies</CardTitle>
      <CardDescription>
        React, Nextjs, PayloadCMS, Strapi, Resend and many more reliable tools.
      </CardDescription>
    </Card>
  );
}
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row shrink-0 justify-center items-center gap-2">
        ...
        <Container className="h-12 w-12 circle-2">
          {/* <ClaudeLogo className="h-4 w-4 " /> */}
          <img src="/payload.svg" alt="Payload logo" height={28} width={28} />
        </Container>
        <Container className="circle-3">
          <img src="/react.svg" height={40} width={40} alt="React logo" />
          {/* <OpenAILogo className="h-8 w-8 dark:text-white" /> */}
        </Container>
        <Container className="h-12 w-12 circle-4">
          <img src="/next.svg" alt="Nextjs logo" height={35} width={35} />
      ...
      <div className="h-40 w-px absolute top-20 m-auto z-40 animate-move">
